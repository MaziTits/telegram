...
const WomenPage = () => {
  ...
  const { perfumes, loading, error } = useProductPolling<Perfume>('women');

  console.log('WomenPage - Current perfumes:', perfumes);
  ...
  return (
    <div className="page">
      ...
      <h1>For Women / Для неё</h1>
      <div className="perfume-grid">
        {perfumes.map((perfume) => {
          console.log('Rendering perfume:', perfume);
          ...
          return (
            ...
            >
              <img 
                ...
                alt={perfume.name}
                onError={(e) => {
                  console.error('Error loading image:', perfume.images[0]?.data);
